...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("sprinkles",0.25,new ArrayList<>(Arrays.asList("red #5","yellow #4","blue #2")));
        Topping topping2 = new Topping("chocolate fudge",0.50,new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("peanut m&ms",0.75,new ArrayList<>(Arrays.asList("dairy", "red #5", "yellow #4", "blue #2", "nuts")));
        Topping topping4 = new Topping("m&ms",0.50,new ArrayList<>(Arrays.asList("dairy", "red #5", "yellow #4", "blue #2" )));
